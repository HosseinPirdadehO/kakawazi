...
class ProfileCompleteSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "type_of_car", "role", "password", "password_confirm"
        ]
...
# class PhoneNumberSerializer(serializers.Serializer):
    # # شماره موبایل که باید به صورت رشته و با اعتبارسنجی مناسب باشد
    # phone_number = serializers.CharField(max_length=15, required=True)
    # # هدف ارسال OTP، مثلاً ثبت‌نام یا بازیابی رمز عبور
    # purpose = serializers.ChoiceField(
    #     choices=[('registration', 'ثبت‌نام'),
